...
import { ItemDetailTableDataSource, ItemDetailTableItem } from './item-detail-table-datasource';
...
export class ItemDetailTableComponent implements AfterViewInit {
  ...
  @ViewChild(MatTable) table!: MatTable<ItemDetailTableItem>;
  ...
  constructor() {
    this.dataSource = new ItemDetailTableDataSource();
  }
